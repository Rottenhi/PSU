...
"""
non_func(x) je funkcija f(x) pod (4-3), a add_noise(y) je funkcija koja dodaje šum na stvarne vrijednosti funkcije odnosno epsilon ono e iz pdf-a. Regresija.
...
linearModel.intercept_ i linearModel.coef_ su parametri modela, odnosno Theta0 i Theta1. Ovaj linija plus prethodna je višedimenzionalna linearna regresija, (4-7) tj. Definiranje modela kao linearne funkcije.
